...
var Visitor = require('vuetify/src/stylus/lib/visitor')
  , units = require('vuetify/src/stylus/lib/units')
  , nodes = require('vuetify/src/stylus/lib/nodes')
  , Stack = require('vuetify/src/stylus/lib/stack')
  , Frame = require('vuetify/src/stylus/lib/stack/frame')
  , utils = require('vuetify/src/stylus/lib/utils')
  , bifs = require('vuetify/src/stylus/lib/functions')
  , dirname = require('path').dirname
  , colors = require('vuetify/src/stylus/lib/colors')
  , debug = require('vuetify/src/stylus/lib/visitor/node_modules/debug')('stylus:evaluator')
  , fs = require('fs');
...
function importFile(node, file, literal) {
  var importStack = this.importStack
    , Parser = require('vuetify/src/stylus/lib/parser')
    , stat;
...
Evaluator.prototype.populateGlobalScope = function(){
  ...
  scope.add(new nodes.Ident(
    'embedurl',
    new nodes.Function('embedurl', require('vuetify/src/stylus/lib/functions/url')({
      limit: false
    }))
  ));
...
Evaluator.prototype.visitQueryList = function(queries){
  ...
  if (1 == queries.nodes.length) {
    ...
    if (val = this.lookup(query.type)) {
      ...
      var Parser = require('vuetify/src/stylus/lib/parser')
