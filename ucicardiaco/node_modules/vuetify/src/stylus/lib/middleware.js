...
var stylus = require('vuetify/src/stylus/lib/stylus')
  , semver = require('vuetify/src/stylus/lib/node_modules/semver')
  , fs = require('fs')
  , url = require('url')
  , dirname = require('path').dirname
  , join = require('path').join
  , sep = require('path').sep
  , debug = require('vuetify/src/stylus/lib/node_modules/debug')('stylus:middleware')
  , mkdir = semver.satisfies(process.version, '>=10.12.0') ? fs.mkdir : require('vuetify/src/stylus/lib/node_modules/mkdirp');
