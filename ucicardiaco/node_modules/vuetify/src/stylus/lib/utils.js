...
var nodes = require('vuetify/src/stylus/lib/nodes')
  , basename = require('path').basename
  , relative = require('path').relative
  , join = require('path').join
  , isAbsolute = require('path').isAbsolute
  , glob = require('vuetify/src/stylus/lib/node_modules/glob')
  , fs = require('fs');
...
exports.compileSelectors = function(arr, leaveHidden){
  var selectors = []
    , Parser = require('vuetify/src/stylus/lib/selector-parser')
    , indent = (this.indent || '')
    , buf = [];
