...
var Parser = require('vuetify/src/stylus/lib/parser')
  ...
  , Evaluator = require('vuetify/src/stylus/lib/visitor/evaluator')
  , Normalizer = require('vuetify/src/stylus/lib/visitor/normalizer')
...
Renderer.prototype.render = function(fn){
  ...
  try {
    ...
    var compiler = this.options.sourcemap
      ? new (require('vuetify/src/stylus/lib/visitor/sourcemapper'))(ast, this.options)
      : new (require('vuetify/src/stylus/lib/visitor/compiler'))(ast, this.options)
...
Renderer.prototype.deps = function(filename){
  ...
  var DepsResolver = require('vuetify/src/stylus/lib/visitor/deps-resolver')
