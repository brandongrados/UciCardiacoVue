                ...
                <v-toolbar-title>Historias</v-toolbar-title>
                    ...
                    <v-dialog v-model="adModal" max-width="290">
                        <v-card>
                            ...
                            <v-card-title class="headline" v-if="adAccion==2">¿Anular Historia?</v-card-title>
                            <v-card-text>
                                Estas a  punto de 
        ...
        methods:{
            ...
            buscarCodigo()   {
                ...
                let configuracion=  {headers : header};
                 axios.get('api/Sintomas/BuscarCodigoHistoria/'+this.codigo,configuracion)
            ...
            listarSintoma() {
                ...
                let header= {"Authorization": "Bearer " + this.$store.state.token};
                let configuracion=  {headers : header};
                 axios.get('api/Sintomas/ListarHistoria/'+me.texto,configuracion).then(function(response)  {
                       //console.log(response);
            ...
            listar()   {
                ...
                if(!me.search)    {
                    ...
                    url='api/Historias/ListarFiltro/'+me.search;
                }
            ...
            guardar () {
                ...
                let configuracion=  {headers : header};              
                let me=this;
                axios.post('api/Historias/Crear',{
                    
                    'idenfermera':me.idenfermera,
                    'idusuario':me.$store.state.usuario.idusuario,
                    'tipo_historia':me.tipo_historia,
                    'serie_historia':me.serie_historia,
                    'num_historia':me.num_historia,
            ...
            validar()   {
                ...
                if(!this.idenfermera){
                    this.validaMensaje.push("Selecciona una enfermera.");
                }
                if(!this.tipo_historia){
                    this.validaMensaje.push("Selecciona una tipo de historia.");
                }
                if(!this.num_historia){
                    this.validaMensaje.push("Ingrese un numero de historia.");
                }
            ...
            activarDesactivarMostrar(accion,item)  {
                this.adModal=1;
                this.adNombre=item.num_historia;
                this.adId=item.idhistoria;
            ...
            */
            ...
            desactivar()    {
                ...
                let header= {"Authorization": "Bearer " + this.$store.state.token};
                let configuracion=  {headers : header};
                axios.put('api/Historias/Anular/'+this.adId,{},configuracion).then(function(response)  {
                    me.adModal=0;
                    me.adAccion=0;
                    me.adNombre="";
                    me.adId="";
