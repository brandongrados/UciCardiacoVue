    ...
    >
      <v-list dense>
        ...
        <template v-if="esAdministrador || esMedico || esSecretaria">
            ...
            <v-list-tile :to="{ name: 'diagnosticos'}">
              <v-list-tile-action>
                <v-icon>table_chart</v-icon>
              </v-list-tile-action>
              <v-list-tile-content>
        ...
        <template v-if="esAdministrador || esMedico">
            ...
            <v-list-tile :to="{ name: 'consultadiagnosticos'}">
              <v-list-tile-action>
                <v-icon>table_chart</v-icon>
              </v-list-tile-action>
              <v-list-tile-content>
                <v-list-tile-title>
                  Consultas Diagnosticos(PREMIUM)
                </v-list-tile-title>
              </v-list-tile-content>
            </v-list-tile>
            <v-list-tile :to="{ name: 'consultahistorias'}">
              <v-list-tile-action>
                <v-icon>table_chart</v-icon>
              </v-list-tile-action>
              <v-list-tile-content>
                <v-list-tile-title>
                  Consultas Historias (PREMIUM)
                </v-list-tile-title>
              </v-list-tile-content>
            </v-list-tile>
          </v-list-group>
